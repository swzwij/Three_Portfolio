...
import { controls, focus } from './controls';
...
{
    _camera = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 0.01, 1000);
...
{
    lerpCamera(_camera, cameraPosition, controls(), focus().position, lerpDuration, true);
}